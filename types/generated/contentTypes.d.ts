...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    preferedLanguage: Attribute.String & Attribute.DefaultTo<'en'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiGroupGroup extends Schema.CollectionType {
  ...
  attributes: {
    ...
    learners: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    numberOfSeatsPurchased: Attribute.Integer & Attribute.DefaultTo<0>;
    numberOfSeatsAvailable: Attribute.Integer & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::group.group',
